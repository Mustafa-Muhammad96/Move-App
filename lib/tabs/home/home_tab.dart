              ...
              children: [
                ...
                CarouselSlider.builder(
                  ...
                  itemBuilder: (_, index, _) => GestureDetector(
                    onTap: () {
                      final movieId = availableMovies[index].id;
                      debugPrint(
                        'Tapped movie id: ${availableMovies[index].id}',
                      );
                      if (movieId != null) {
                        Navigator.pushNamed(
                          context,
                        ...
                        debugPrint('Movie id is null!');
                      }
                    },
                    child: AvailableNowItems(
                      imageUrl: availableMovies[index].mediumCoverImage!,
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, index) => GestureDetector(
                      onTap: () {
                        final movieId = sectionMovies[index].id;
                        if (movieId != null) {
                          Navigator.pushNamed(
                            context,
                            AppRoutes.movieDetailsScreen,
                      ...
                      child: ActionItems(
                        imageUrl: sectionMovies[index].mediumCoverImage
                            .toString(),
                        movieId: sectionMovies[index].id!,
                      ),
                    ),
